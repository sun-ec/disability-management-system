...
<body>
		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑残障需求</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>残障需求管理</span></li>
								<li class="breadcrumb-item active"><span>编辑残障需求</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">残障需求信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>残障凭证</label>
										<div><img id="canzhangpingzhengImg" src="" width="100" height="100">
										<div class="upload">选择文件<input name="file" type="file" id="canzhangpingzhengupload" class="form-control-file"></div>
										<input name="canzhangpingzheng" id="canzhangpingzheng-input" type="hidden"></div>
									</div>
									<div class="form-group col-md-6">
										<label>需求内容</label>
										<textarea  name="xuqiuneirong" class="form-control" id="xuqiuneirong" rows="3"></textarea>
									</div>
									<div class="form-group col-md-6">
										<label>申请时间</label>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "canzhangxuqiu/info/" + id,
		...
		// 文件上传
		function upload(){
			$('#canzhangpingzhengupload').fileupload({
				url: baseUrl + 'file/upload',
				headers:{ token: window.sessionStorage.getItem("token")},
				dataType: 'json',
				done: function (e, data) {				
					document.getElementById('canzhangpingzheng-input').setAttribute('value',"upload/"+data.result.file);
					if(document.getElementById('canzhangpingzhengFileName') != null){
						document.getElementById('canzhangpingzhengFileName').innerHTML = "上传成功!";
					}				
					$("#canzhangpingzhengImg").attr("src",baseUrl+"upload/"+data.result.file);								
				}
			});
		}  
		//取消 
				...
				if(crossrefid && crossuserid) {
					...
					http("canzhangxuqiu/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("canzhangxuqiu/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("canzhangxuqiu/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function calculationSE(colName){
			//单列求和接口
			http("canzhangxuqiu"+colName,"GET",{
			...
			function fill(){
				...
				http(accountTableName+'/session','GET',{},(res)=>{
					if(res.code == 0){
						...
						if(res.data !=null && res.data.canzhangpingzheng != null && res.data.canzhangpingzheng != ''){
                            $('#canzhangpingzheng-input').val(res.data.canzhangpingzheng)
                            $("#canzhangpingzhengImg").attr("src",baseUrl+res.data.canzhangpingzheng);
						}
						$(validform());
					}
				});
		...
		function dataBind(){
			...
			$("#canzhangpingzheng-input").val(ruleForm.canzhangpingzheng);
			$("#xuqiuneirong").val(ruleForm.xuqiuneirong);
		...
		//图片显示
		function showImg(){
			var canzhangpingzhengFileName = "\"" + ruleForm.canzhangpingzheng + "\"";
			$("#canzhangpingzhengImg").attr("src",baseUrl+ruleForm.canzhangpingzheng);
		}		
		//跨表
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.canzhangpingzheng != null && res.data.canzhangpingzheng != ''){

						$("#canzhangpingzhengImg").attr("src",baseUrl+res.data.canzhangpingzheng);
						$("#canzhangpingzheng-input").val(res.data.canzhangpingzheng);
					}
					if(res.data != null && res.data != '' && res.data.xuqiuneirong != null && res.data.xuqiuneirong != ''){

						$("#xuqiuneirong").val(res.data.xuqiuneirong);
					}
