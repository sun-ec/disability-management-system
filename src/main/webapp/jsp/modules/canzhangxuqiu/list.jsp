...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">残障需求管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>残障需求列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">残障需求列表</h3>							
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var canzhangpingzhengCell  = document.createElement('td');

				                var canzhangpingzhengImg = document.createElement('img');
			canzhangpingzhengImg.setAttribute('src',baseUrl+item.canzhangpingzheng);
			canzhangpingzhengImg.setAttribute('height',100);
			canzhangpingzhengImg.setAttribute('width',100);
			canzhangpingzhengCell.appendChild(canzhangpingzhengImg);


			row.appendChild(canzhangpingzhengCell);
			var xuqiuneirongCell  = document.createElement('td');

						  if(item.xuqiuneirong != null && item.xuqiuneirong != "" && item.xuqiuneirong.length >= 11){
			  	xuqiuneirongCell.innerHTML = item.xuqiuneirong.substring(0, 10) + "..."; 
			  }else{
			  	xuqiuneirongCell.innerHTML = item.xuqiuneirong;
			  }


			row.appendChild(xuqiuneirongCell);
		...
		function sh(){
			...
			httpJson("canzhangxuqiu/update","POST",data,(res)=>{
				if(res.code == 0){
					alert("提交成功");
					getDataList();
				}
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("canzhangxuqiu/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"canzhangxuqiu");
