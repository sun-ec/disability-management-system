...
<style>
	...
	body {
		...
		width: 100%;
		height: 100%;
						background-image: url(http://codegen.caihongy.cn/20210125/25772a3e8d9b4a719f7e6e6558b68c2a.jpg) !important;
					}
	.container {
		padding: 0;
		margin: 0;
	...
	<div class="container" style="position: relative;">
		...
		<div class="" id="login-wrapper">
			...
			<form id="registerForm" action="" method="post">
							...
							<input  name="dizhi" placeholder="地址" class="form-control-i">
							</div>
