...
<style>
	...
	.news ul li {
		line-height: 26px;
		padding: 8px 0px;
		background: url(../../../resources/images/pg_icon.jpg) no-repeat left 16px;
		padding-left: 20px;
		height: 20px;
		overflow: hidden;
	}
...
<%--					:style='{"padding":"0 10px","boxShadow":"none","margin":"10px 0 10px 0","borderColor":"#006633","backgroundColor":"#669933","borderRadius":"4px","borderWidth":"1px","borderStyle":"solid","justifyContent":"flex-end","height":"64px"}'>--%>
<%--					<div class="item-list">--%>
<%--						<div class="lable"--%>
...
<%--							标题</div>--%>
<%--						<input type="text"--%>
<%--							:style='{"boxShadow":"0 0 6px rgba(255,0,0,0)","borderColor":"#ccc","backgroundColor":"#fff","color":"#333","borderRadius":"8px","textAlign":"center","borderWidth":"0","width":"140px","fontSize":"14px","borderStyle":"solid","height":"44px"}'--%>
<%--							name="title" id="title" placeholder="标题" autocomplete="off" class="layui-input">--%>
<%--					</div>--%>
<%--					<button--%>
<%--						:style='{"padding":"0 15px","boxShadow":"0 0 8px rgba(0,0,0,0)","margin":"0 0 0 10px","borderColor":"#409EFF","backgroundColor":"#409EFF","color":"#fff","borderRadius":"4px","borderWidth":"0","width":"auto","fontSize":"14px","borderStyle":"solid","height":"40px"}'--%>
...
<%--				</form>--%>
				...
				<div class="list news">
					<ul>
						<li>
							<a @click="concentDetail(0)">春季养生小常识 </a>
							<span class="list_time">2022-02-16</span>
						</li>
						<li>
							<a @click="concentDetail(1)">如何去除甲醇</a>
							<span class="list_time">2022-01-25</span>
						</li>
						<li>
							<a @click="concentDetail(2)">维生素C一天的正常摄入量 </a>
							<span class="list_time">2022-01-22</span>
						</li>
						<li>
							<a @click="concentDetail(3)">高血压患者当心危及生命的8个动作</a>
							<span class="list_time">2022-01-12</span>
						</li>
						<li>
							<a @click="concentDetail(4)">如何预防老年疾病:脑血栓 </a>
							<span class="list_time">2021-12-22</span>
						</li>
					</ul>
				</div>
	...
	<script>
		var vue = new Vue({
			...
			methods: {
				...
				concentDetail(index) {
					jump(`../policies/detail.jsp?index=${index}&type=garden`);
				}
			}
		})
