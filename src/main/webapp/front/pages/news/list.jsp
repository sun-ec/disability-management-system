			...
			<div class="recommend index-pv2" :style='{"padding":"10px 0 10px 0","boxShadow":"none","margin":"10px 0 0 0","borderColor":"rgba(0,0,0,.3)","backgroundColor":"rgba(203, 183, 159, 1)","borderRadius":"0","borderWidth":"0","background":"#8fbc8f","borderStyle":"solid"}'>
				...
				<form class="layui-form filter" :style='{"padding":"0 10px","boxShadow":"none","margin":"10px 0 10px 0","borderColor":"#006633","backgroundColor":"#669933","borderRadius":"4px","borderWidth":"1px","borderStyle":"solid","justifyContent":"flex-end","height":"64px"}'>
					<div class="item-list">
						...
						<input type="text" :style='{"boxShadow":"0 0 6px rgba(255,0,0,0)","borderColor":"#ccc","backgroundColor":"#fff","color":"#333","borderRadius":"8px","textAlign":"center","borderWidth":"0","width":"140px","fontSize":"14px","borderStyle":"solid","height":"44px"}' name="title" id="title" placeholder="请输入标题" autocomplete="off" class="layui-input">
					</div>
					...
					<div class="list news">
						<div @click="jump('../news/detail.jsp?id='+item.id);" v-for="(item,index) in dataList" :key="index" class="list-item" :class="2=='1'?'list-item1':2=='3'?'list-item3':''">
							<div class="list-item-body animation-box" :style='{"padding":"10px","boxShadow":"0 0 6px rgba(0,0,0,0.3)","margin":"0 0 10px 0","borderColor":"rgba(0,0,0,.3)","backgroundColor":"#fff","borderRadius":"4px","borderWidth":"0","borderStyle":"solid"}'>
								<img :style='{"boxShadow":"none","borderColor":"rgba(0,0,0,.3)","borderRadius":"0","borderWidth":"0","width":"50%","borderStyle":"solid","height":"200px"}' :src="baseurl+item.picture">
								<div class="item-info">
									<div v-if="true" :style='{"isshow":true,"padding":"0","margin":"5px 0 0 0","backgroundColor":"rgba(0,0,0,0)","color":"rgba(97, 73, 46, 1)","borderRadius":"0","textAlign":"left","width":"100%","fontSize":"20px"}' class="name">{{item.title}}</div>
									<div v-if="item.introduction" :style='{"padding":"0","margin":"10px 0 0 0","backgroundColor":"rgba(0,0,0,0)","color":"rgba(97, 73, 46, 1)","borderRadius":"0","textAlign":"left","width":"100%","fontSize":"16px"}' class="time">{{item.introduction}}</div>
								</div>
							</div>
						</div>
					</div>
